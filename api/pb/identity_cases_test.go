...
var identityCases = []identityCase{
	...
	{"pypi version wheel tags are not a version", pypi, "pkg", "1.0.0-py3-none-any", "pkg", "1.0.0-py3-none-any", false},
...
var identityDistinctCases = []identityDistinctCase{
	...
	{"pypi local segment is another version", identitySide{pypi, "pkg", "1.0"}, identitySide{pypi, "pkg", "1.0+local.1"}},
	...
	{"npm case makes another package", identitySide{npm, "JSONStream", "1.0.3"}, identitySide{npm, "jsonstream", "1.0.3"}},
	{"npm scope case makes another package", identitySide{npm, "@Vue/Reactivity", "1"}, identitySide{npm, "@vue/reactivity", "1"}},
