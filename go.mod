...
require (
	buf.build/gen/go/safedep/api/grpc/go v1.6.2-20260814052054-5a66b8ff3835.1
	buf.build/gen/go/safedep/api/protocolbuffers/go v1.36.12-20260814052054-5a66b8ff3835.1
